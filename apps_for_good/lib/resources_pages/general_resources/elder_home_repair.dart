...
// This class is used for the page related to the Elder Home Repair services offerred by the CMAA. 

class Elder_Home_Repair extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Elder Home Repair')),
      drawer: Container(),
      body: Center(
        child: Column(
          ...
          children: [
            const Text(
              'Welcome to Elder Home Repair!'
              '\n This program focuses on elders living in unsafe housing who are at risk for their health and safety.'
               '\n It expands housing options for elders who want to remain in their own residence.',
