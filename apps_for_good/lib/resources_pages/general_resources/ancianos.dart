...
// This class is used for the page related to the services of the Ancianos Latinos Unidos offerred by the CMAA. 


class Ancianos_Latinos_Unidos extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Ancianos Latinos Unidos')),
      drawer: Container(),
      body: Center(
        child: Column(
          ...
          children: [
            const Text(
              'Welcome to Ancianos Latinos Unidos!'
              '\n Service Area: Fitchburg & Leominster'
              '\n Services include outreach, information and assistance, home visits, interpretation, and translation.'
             '\n One of the key aspects of the program is to prevent social isolation and increase elder involvement in the community.',
