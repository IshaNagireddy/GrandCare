...
// This class is used for the page related to the services of the Nutrition Project offerred by the CMAA. 


class Nutrition_Project extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Nutrition Project')),
      drawer: Container(),
      body: Center(
        child: Column(
          ...
          children: [
            const Text(
              'Welcome to Nutrition Project!'
              '\n Serves congregate and home delivered meals to elders in their service area.',
