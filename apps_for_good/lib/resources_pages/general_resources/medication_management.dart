...
// This class is used for the page related to the Medication Management services offerred by the CMAA. 

class Medication_Management extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            const Text(
              'Welcome to Medication Management'
              '\n Provides public presentations on medication management issues as well as one to one consultation with elders where needed.' 
              '\n In addition, MassMedLine has developed educational media regarding medication management for distribution throughout Central Massachusetts.',
