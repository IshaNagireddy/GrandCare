...
class ResourcesMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'CareExpress Main Page',
          style: GoogleFonts.poppins(),
        ),
      ),
      body: MyHomePage(),
      backgroundColor: Color.fromARGB(
          255, 14, 37, 57), // Use MyHomePage as the body of the Scaffold
    );
  }
}
        ...
        children: [
              ...
              Expanded(
                child: Padding(
                  padding: const EdgeInsets.all(
                      15.0), // Increased padding to make the button bigger
                  child: Container(
                    decoration: BoxDecoration(
                      border: Border.all(
                        color: Colors
                            .grey, // Change this to your preferred border color
                      ...
                      child: ListTile(
                        ...
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => RequestsContainer()),
                          );
                        },
                      ),
                    ),
          ...
          CarouselSlider(
            ...
            items: dropdownOptions
                .map((option) => FractionallySizedBox(
                      widthFactor: 0.8,
                          ...
                          showDialog(
                            ...
                            builder: (BuildContext context) {
                              return AlertDialog(
                                ...
                                backgroundColor:
                                    Color.fromARGB(255, 193, 220, 244),
                                    ...
                                    children: <Widget>[
                                      Text(
                                          dropdownDescriptions[
                                              dropdownOptions.indexOf(option)],
                                          style: GoogleFonts
                                              .poppins()), // Display the description
                                    ],
                                  ),
                                ),
                                actions: <Widget>[
